...
class ProfilePageState extends State<ProfilePage>
  ...
  TextEditingController ageC;
  TextEditingController heightC;
  ...
  @override
  void initState() {
    nameC = new TextEditingController(text: widget.user.nom);
    emailC = new TextEditingController(text: widget.user.username);
    ageC = new TextEditingController(text: widget.user.age.toString());
    heightC = new TextEditingController(text: widget.user.height.toString());
    weightC = new TextEditingController(text: widget.user.weight.toString());
    passC = new TextEditingController(text: widget.user.password);
    _activitySelected = widget.user.getActivity();
    _sexSelected = widget.user.sexe;
    _currentAge = widget.user.age;
    _goalSelected = widget.user.goal;
    super.initState();
  }

  void updateUser() {
    var url = "http://10.0.2.2/projetpfe/editUser.php";
    ...
    User newUser = new User(widget.user.id,nameC.text,emailC.text,passC.text,_sexSelected,int.parse(ageC.text),int.parse(heightC.text),int.parse(weightC.text),_goalSelected,_activitySelected);
    Navigator.push(context, MaterialPageRoute(builder: (context) => ProfilePage(user: newUser)));
  }
                      ...
                      Padding(
                          ...
                          child: new Row(
                            ...
                            children: <Widget>[
                              new Flexible(
                                child: _status
                                    ? Text(widget.user.nom ?? 'default value',
                                        style: TextStyle(
                                            fontSize: 14.0,
                                            color:
                          ...
                          child: new Row(
                            ...
                            children: <Widget>[
                              Container(
                                width: 130,
                                child: _status
                                    ? Text(widget.user.sexe ?? 'default value',
                                        style: TextStyle(
                                            fontSize: 14.0,
                                            color:
                                                Theme.of(context).buttonColor,
              ...
              child: Container(
                ...
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            MesCommandesPage(user: widget.user),
                      ));
                },
                shape: new RoundedRectangleBorder(
                    borderRadius: new BorderRadius.circular(20.0)),
