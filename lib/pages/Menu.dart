...
class Menu extends StatelessWidget {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                _buildListItem('assets/plate1.png', 'Vegan Breakfast', '\$28', context),
                _buildListItem('assets/plate2.png', 'Protein Salad', '\$26', context)
              ],
            ),
          ),
          SizedBox(height: 20.0),
  ...
  Widget _buildListItem(String imgPath, String foodName, String price, BuildContext context) {
    return InkWell(
        onTap: () {
